    ...
    return ( !loading ?
        <TableContainer component={Paper}>
            <Table>
                <TableHead>
                    <TableRow>
                        <TableCell>{i18n.t("dashboard.agent")}</TableCell>
                        <TableCell align="center">{i18n.t("dashboard.evaluations")}</TableCell>
                        <TableCell align="center">{i18n.t("dashboard.tmConversations")}</TableCell>
                        <TableCell align="center">{i18n.t("dashboard.status")}</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    { renderList() }
